...
import { EarningsData, AllocationData, StockData } from '../types';

const mockEarningsData: EarningsData[] = [
  { company: 'Apple', surprise: 5.2 },
  { company: 'Microsoft', surprise: -2.4 },
  { company: 'Google', surprise: 3.1 },
];
